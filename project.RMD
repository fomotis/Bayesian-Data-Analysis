...
parameters.to.save=c("beta0","beta1","beta2","beta3","beta4","sigma.e","sigma.b"),n.iter=50000,n.burnin=25000,n.chains=length(mastitisini),model.file="mastitis2.jag",n.thin=1,DIC=T)
...
parameters.to.save=c("beta0","beta1","beta2","beta3","beta4","sigma.e","sigma.b"),n.iter=40000,n.burnin=20000,n.chains=3,model.file="mastitis_hcentering.jag",n.thin=1,DIC=T)
...
cat("
    ...
    ",file="mastitis_hcenteringPPC.jag")

mastitis_ppc <- jags(data=mastitisdata,inits=mastitisini,
parameters.to.save=c("ppc_test","ppc_measure"),n.iter=40000,n.burnin=20000,n.chains=3,model.file="mastitis_hcenteringPPC.jag",n.thin=1,DIC=T)
...
cat("
    ...
    ",file="mastitis_hcenteringP2.jag")

mastitis_prior1 <- jags(data=mastitisdata,inits=mastitisini,
parameters.to.save=c("beta0","beta1","beta2","beta3","beta4"),n.iter=40000,n.burnin=20000,n.chains=3,model.file="mastitis_hcenteringP2.jag",n.thin=1,DIC=T)
...
cat("
    ...
    ",file="mastitis_hcenteringP3.jag")

mastitis_prior2 <- jags(data=mastitisdata,inits=mastitisini,
parameters.to.save=c("sigma.b","sigma.e","b"),n.iter=40000,n.burnin=20000,n.chains=3,model.file="mastitis_hcenteringP3.jag",n.thin=1,DIC=T)
...
cat("
    ...
    ",file="mastitis_hcenteringnoHiefer.jag")
...
parameters.to.save=c("beta0","beta2","beta3","beta4","sigma.e","sigma.b"),n.iter=40000,n.burnin=20000,n.chains=3,model.file="mastitis_hcenteringnoHiefer.jag",n.thin=1,DIC=T)
...
cat("
    ...
    ",file="mastitis_hcenteringnoQuarter.jag")
...
parameters.to.save=c("beta0","beta1","sigma.e","sigma.b"),n.iter=40000,n.burnin=20000,n.chains=3,model.file="mastitis_hcenteringnoQuarter.jag",n.thin=1,DIC=T)
...
cat("
    ...
    ",file="mastitis_hcenteringnoCovariates.jag")
...
parameters.to.save=c("beta0","sigma.e","sigma.b"),n.iter=40000,n.burnin=20000,n.chains=3,model.file="mastitis_hcenteringnoCovariates.jag",n.thin=1,DIC=T)
...
mastitis_inimodel <- jags(data=mastitis_independent_data,inits=mastitis_independent_ini, parameters.to.save=c("beta0","beta1","beta2","beta3","beta4","sigma.e"),n.iter=40000,n.burnin=20000,n.chains=3,model.file="mastitis_independent.jag",n.thin=1,DIC=T)
...
cat("
    ...
    ",file="mastitis_median.jag")

mastitis_median <- jags(data=mastitisdata,inits=mastitisini,
parameters.to.save=c("med_Q4_h0","med_Q4_h1","med_Q1_h0","med_Q1_h1","med_Q2_h0","med_Q2_h1","med_Q3_h0","med_Q3_h1"),n.iter=40000,n.burnin=20000,n.chains=3,model.file="mastitis_median.jag",n.thin=1,DIC=T)
...
cat("
    ...
    ",file="mastitis_hcentering_trandom.jag")

mastitis_hmodel_trandom <- jags(data=mastitisdata,inits=mastitisini,
parameters.to.save=c("beta0","beta1","beta2","beta3","beta4","sigma.e","sigma.b"),n.iter=40000,n.burnin=20000,n.chains=3,model.file="mastitis_hcentering_trandom.jag",n.thin=1,DIC=T)

#monitoring Random effects
mastitis_hmodel2_trandom <- jags(data=mastitisdata,inits=mastitisini,
parameters.to.save=c("b"),n.iter=40000,n.burnin=20000,n.chains=3,model.file="mastitis_hcentering_trandom.jag",n.thin=1,DIC=T)
...
parameters.to.save=c("beta0","beta1","beta2","beta3","beta4","sigma","sigma.b"),n.iter=15000,n.burnin=5000,n.chains=3,model.file="mastitis.jag")
...
rabbit_model1 <- jags(data=rabbit_data,inits=rabbit_init,parameters.to.save=c("gamma","beta","alpha","sigma.e"),n.thin=10,n.iter=100000,n.burnin=50000,n.chains=3,model.file="rabbits1.jag")
...
rabbit_model2 <- jags(data=rabbit_data2,inits=rabbit_init2,parameters.to.save=c("gamma","beta","alpha","sigma.e","epsilon"),n.thin=1,n.iter=100000,n.burnin=50000,n.chains=3,model.file="rabbits2.jag")
